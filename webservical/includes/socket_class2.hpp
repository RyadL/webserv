...
class socket_class 
{
    ...
    {
        std::cout << it->second->bytes_inside_body << " " << it->second->body_size <<std::endl;
        int ret = 0;
    ...
    {
        std::cout << "GET_LONG_BODY" << std::endl;
 
        struct stat sb;
        int ret = 0;
        if (!it->second->state_suspended)
        {
            std::cout << "AIEAIEAIE" << std::endl;
        ...
        it->second->_bytes_inside_file_body += ret;
        std::cout << "it->second->_bytes_inside_file_body: " << it->second->_bytes_inside_file_body << std::endl;
        usleep (500);
        ...
        if (it->second->size == it->second->body_size)
        {
            ...
            std::cout << "it->second->_bytes_inside_file_body:" << it->second->size << std::endl;
            it->second->state_suspended = false;
            it->second->is_long_body = true;
            it->second->currently[3] = false;
    ...
    {
        std::cout << "\x1B[37mrefresh1\033[0m" << std::endl;
